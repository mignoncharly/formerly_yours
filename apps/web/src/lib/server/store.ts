...
//
// We append newline-delimited JSON to files under OWY_DATA_DIR (default ./data).
// This keeps Phase 0 dependency-free and trivially deployable on the Ubuntu
// VPS — point OWY_DATA_DIR at a persistent path/volume in production. When we
// reach Phase 1 this is replaced by Supabase.
// ---------------------------------------------------------------------------

const DATA_DIR = process.env.OWY_DATA_DIR
  ? path.resolve(process.env.OWY_DATA_DIR)
