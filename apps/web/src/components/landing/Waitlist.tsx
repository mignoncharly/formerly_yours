...
export function Waitlist() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("owy:set-intent", onSetIntent);
    return () => window.removeEventListener("owy:set-intent", onSetIntent);
  }, []);
  ...
  if (status === "done") {
    return (
      <div className="owy-card owy-rise p-8 text-center">
  ...
  return (
    <form onSubmit={onSubmit} className="owy-card p-6 sm:p-8">
      <fieldset className="mb-4">
        <legend className="owy-eyebrow mb-2">What brings you here?</legend>
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <button
          ...
          className="owy-btn owy-btn-primary shrink-0 disabled:opacity-60"
        >
