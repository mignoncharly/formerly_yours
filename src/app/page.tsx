  ...
  return (
    <main>
      ...
      <header className="sticky top-0 z-40 border-b border-[var(--color-line)] bg-[color-mix(in_oklab,var(--color-ink)_82%,transparent)] backdrop-blur">
        <div className="fy-container flex h-16 items-center justify-between">
          <Logo />
          <nav className="flex items-center gap-2">
            <Link href="/feed" className="fy-btn fy-btn-ghost !px-4 !py-2 text-sm">
              See the feed
            </Link>
            <a href="#waitlist" className="fy-btn fy-btn-primary !px-4 !py-2 text-sm">
              Join
            </a>
          </nav>
        </div>
      ...
      <section className="relative overflow-hidden">
        ...
        />
        <div className="fy-container relative grid gap-12 py-14 sm:py-20 lg:grid-cols-2 lg:items-center">
          <div className="fy-rise">
            <span className="fy-eyebrow">Every object has a story</span>
          ...
          {/* Example story */}
          <div className="fy-rise" style={{ animationDelay: "0.1s" }}>
      ...
      <section className="border-t border-[var(--color-line)] py-16">
        <div className="fy-container">
          <span className="fy-eyebrow">How it works</span>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              ...
              <div key={s.n} className="fy-card p-6">
      ...
      <section className="border-t border-[var(--color-line)] py-16">
        <div className="fy-container grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <span className="fy-eyebrow" style={{ color: "var(--color-chapter)" }}>
          ...
          <div className="fy-card p-6">
            <div className="flex items-center justify-between">
              ...
              <span className="fy-chip">3 items sold</span>
            </div>
            ...
            <div className="fy-progress mt-2">
              <span style={{ width: "56%" }} />
            </div>
      ...
      {/* Safety philosophy */}
      <section className="border-t border-[var(--color-line)] py-16">
        <div className="fy-container max-w-3xl text-center">
          <span className="fy-eyebrow">Safety by design</span>
      ...
      <section id="waitlist" className="border-t border-[var(--color-line)] py-16">
        <div className="fy-container grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            <span className="fy-eyebrow">Be early</span>
            <h2 className="mt-3 font-[family-name:var(--font-display)] text-3xl sm:text-4xl">
              Join the waitlist
            </h2>
      ...
      <footer className="border-t border-[var(--color-line)] py-10">
        <div className="fy-container flex flex-col items-center justify-between gap-4 sm:flex-row">
          <Logo />
          <p className="text-sm text-[var(--color-faint)]">
            © {new Date().getFullYear()} Formerly Yours · Working name ·
            Concept validation
          </p>
          <Link
            href="/feed"
