  ...
  return (
    <div className="relative bg-[var(--color-ink)]">
      ...
      <div className="pointer-events-none fixed inset-x-0 top-0 z-40">
        <div className="fy-container flex h-14 items-center justify-between">
          <Link href="/" className="pointer-events-auto">
            <Logo className="text-sm" />
          </Link>
          <div className="pointer-events-auto flex items-center gap-2">
            <span className="fy-chip">Preview · fictional stories</span>
            <a href="/#waitlist" className="fy-btn fy-btn-primary !px-3 !py-1.5 text-xs">
              Join
            </a>
          </div>
        </div>
      ...
      <div className="fy-feed">
        ...
        {/* Closing slide */}
        <section className="fy-slide grid place-items-center">
          <div className="fy-container max-w-md text-center">
            ...
            <div className="mt-6 flex justify-center gap-3">
              <a href="/#waitlist" className="fy-btn fy-btn-primary">
                Join the waitlist
              </a>
              <Link href="/" className="fy-btn fy-btn-ghost">
                Back to home
              </Link>
            </div>
          </div>
...
function FeedSlide({ item, index }: { item: FeedItem; index: number }) {
  ...
  return (
    <section
      ref={ref}
      className="fy-slide relative flex flex-col justify-end overflow-hidden"
    >
      {/* Full-bleed "photo" */}
      <div
        aria-hidden
      ...
      <div className="absolute bottom-40 right-3 z-20 flex flex-col items-center gap-3 sm:bottom-28">
        ...
        {item.pastSold && (
          <span className="fy-chip !bg-[color-mix(in_oklab,var(--color-chapter)_18%,transparent)]">
            Past Sold ✓
          </span>
        )}
      </div>
      ...
      <div className="relative z-10 w-full bg-[linear-gradient(180deg,transparent,var(--color-ink)_45%)] px-4 pb-8 pt-24">
        <div className="fy-container max-w-2xl">
          <div className="mb-2 flex flex-wrap items-center gap-2">
            <span className="fy-chip">
            ...
            {item.story.visibility === "anonymous" && (
              <span className="fy-chip">🕶️ Anonymous</span>
            )}
          </div>
          ...
          <div className="mt-4 flex gap-2">
            <button
              className="fy-btn fy-btn-primary flex-1"
              disabled={interested}
              onClick={() => {
                setInterested(true);
